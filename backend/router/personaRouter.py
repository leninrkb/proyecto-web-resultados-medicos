...
@router_persona.post('/create_persona')
...
@router_persona.get('/get_personas')
...
@router_persona.get('/get_persona_id/{id}')
...
@router_persona.post('/update_persona')
...
@router_persona.delete('/delete_persona/{id}')
